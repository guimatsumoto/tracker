...
namespace Bayesian_filter {
    ...
    public:
        ...
        const FM::Vec& f(const FM::Vec& x) const { // Provide the linear implementation of functional f
    ...
    public:
        ...
        const FM::Vec& h(const FM::Vec& x) const { // Provide a linear implementation of functional h assumes model is already Linrz for Hx
