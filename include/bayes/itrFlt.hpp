...
namespace Bayesian_filter {
    ...
    public:
        ...
        Float observe(Linrz_uncorrelated_observe_model& h, const FM::Vec& z) { // Observe with default termination
            Iterated_terminator term;
            return observe(h, term, z);
        }

        Float observe(Linrz_correlated_observe_model& h, const FM::Vec& z) { // Observe with default termination
            Iterated_terminator term;
            return observe(h, term, z);
        }
